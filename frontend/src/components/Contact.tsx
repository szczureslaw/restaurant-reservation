const Contact = () => {
  return (
    <section id="kontakt" className="py-16 bg-white fade-in">
      <div className="container mx-auto px-4 max-w-4xl">
        <h2 className="text-3xl font-bold text-center mb-8 text-primary">Kontakt</h2>
        <div className="flex flex-col md:flex-row gap-10">
          <div className="md:w-1/2">
            <h3 className="text-xl font-semibold mb-4">Dane kontaktowe</h3>
            <p className="mb-2">📍 ul. Smakowita 12, 00-001 Warszawa</p>
            <p className="mb-2">📞 +48 123 456 789</p>
            <p className="mb-4">✉️ kontakt@gusto.pl</p>
            <h4 className="font-medium mb-2">Godziny otwarcia:</h4>
            <ul className="text-dark space-y-1">
              <li>Pon–Pt: 12:00–22:00</li>
              <li>Sobota: 14:00–23:00</li>
          ...
          <div className="md:w-1/2 bg-gray-200 rounded-lg h-64 flex items-center justify-center">
            <p className="text-gray-600">Mapa Google</p>
          </div>
        </div>
      </div>
    </section>
